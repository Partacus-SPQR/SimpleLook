...
- **Free Look Camera** - Look around independently from movement
- **Smooth Animation** - Camera smoothly returns to center
...
1. Go to **Options > Controls > Key Binds > SimpleLook**
2. Bind "Free Look" to your preferred key (recommended: **Left Alt**)
3. Hold your bound key and move your mouse
4. Your camera rotates while your body keeps its direction
5. Release and the camera returns smoothly
